...
import com.example.watch.presentation.SearchActivity
import com.example.watch.models.Movie

import com.squareup.picasso.Picasso


class SearchAdapter(private var movieList: List<Movie>, private var context: Context, var listener: SearchActivity.RecyclerItemListener) : RecyclerView.Adapter<SearchAdapter.SearchMoviesHolder>() {
